...
const Register = () => {
    ...
    return (
        <div className="w-96 mx-auto my-10">
            ...
            <input onClick={handleGoogleSignIn} className=" border-2 border-primary hover:bg-primary-dark  font-medium py-2 px-4 rounded-full focus:outline-none focus:shadow-outline cursor-pointer mx-auto block text-center mt-4 hover:text-white w-full bg-white" type="button" value="Signin With Google" />
        </div>
    );
};
